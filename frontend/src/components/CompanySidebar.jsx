export default function CompanySidebar({ active, onNav, orgName, initials, counts }) {
  const navItems = [
    {
      id: 'dashboard',
      label: 'Dashboard',
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-section-label">Company Menu</div>
